...
const BoolSelectInput = (props) => {
    return (
        <label htmlFor={props.name} className="m-1 w-full">
            ...
            focus:invalid:border-red-500 focus:invalid:ring-red-500"
                id={props.name} name={props.name} value={props.value} onChange={props.onChange} >
...
export default BoolSelectInput;